...
if ($valor_liquidacion < $valor_tarifa_evento_25) {
 ...
 $valor_liquidacion_r = 3332600 *   $numero_dias * $cantidad ;
  ...
  $valor_liquidacion = 6242123  *  $numero_dias * $cantidad ;
 ...
 $valor_liquidacion = 104039624  *  $numero_dias * $cantidad ;
 $valor_liquidacion_r = 104039620 *  $numero_dias * $cantidad ;
  ...
  $valor_liquidacion =$valor_liquidacion * 0.5;
}elseif ($valor_liquidacion  == $valor_tarifa_evento_2115 ) {
  $valor_tarifa =$valor_liquidacion * 0.6;
