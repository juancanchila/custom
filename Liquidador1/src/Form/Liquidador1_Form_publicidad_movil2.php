 ...
 */
class Liquidador1_Form_publicidad_movil2 extends FormBase
{
	 /**
   * The mail manager.
   *
...
'#states' =>array(
  ...
  $form['valor_evento'] = array(
    ...
    $validators = array(
      ...
      '#size' => 20,
      '#description' => 'Documento Identidad: Representante Legal',
...
$form['my_captcha_element'] = array(
  ...
  {
    return 'Liquidador1_Form_publicidad_movil2';
  }
...
if ($valor_liquidacion  <= $valor_tarifa_evento_25) {
  ...
  $valor_liquidacion = 1830885 * $numero_dias   ;
