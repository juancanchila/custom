 ...
 */
class Liquidador1_Form_publicidad2 extends FormBase
{
...
$form['my_captcha_element'] = array(
  ...
  {
    return 'Liquidador1_Form_publicidad_fija2';
  }
...
$valor_liquidacion = $valor_evento ;
...
if ($valor_liquidacion  <= $valor_tarifa_evento_25) {
  ...
  $valor_liquidacion = ( ($valor_evento * 10)/100) * $numero_dias  ;
}
