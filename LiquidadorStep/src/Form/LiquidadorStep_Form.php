...
$codigo_liquidacion = $page_values['id_document'];

$barrio_liquidacion = $page_values['barrio'];
$direccion_predio_liquidacion =  $page_values['dir_predio'];
$name_predio=  $page_values['name_predio'];
$numero_arboles  = $page_values['cantidad_arboles'];
$especie_arboles  = $page_values['especie'];
$tipo_solicitante =  $page_values['tipo_de_solicitante'];
$id_contribuyente =  $page_values['id_document'];
$name_contrib=  $page_values['name'];
...
$dir_correspondecia_contrib =  $page_values['dir_correspondencia'];
$email_cotrib =  $page_values['email'];
$tfijo =  $page_values['tfijo'];
$tmovil = $page_values['tmovil'];
$estrato =  $page_values['estrato'];
$condicion = $page_values['condicion'];
/*
