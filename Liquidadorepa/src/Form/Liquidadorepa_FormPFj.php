...
class Liquidadorepa_FormPFj extends FormBase
{
 ...
 /**
  ...
  {
    $dir_vallas =  $this->session->get('session_liquidacion.direccion_vallas', '');
...
*/
  ...
  $cantidad_v = 0;
      ...
      if (!empty($dir_vallas1)) {
	   ...
	   $this->setSessionValue('session_liquidacion.cantidad_v_pfj', $cantidad_v);
...
if ($valor_liquidacion < $valor_tarifa_evento_25) {
        ...
        $valor_liquidacion_r = 166200 *  $numero_dias *$cantidad_v  ;
          ...
          $valor_tarifa =237598;
        $valor_liquidacion =237598  *  $numero_dias * $cantidad_v  ;
        $valor_liquidacion_r = 237600 *   $numero_dias * $cantidad_v  ;
          ...
          $valor_tarifa =332829;
        $valor_liquidacion = 332829  *   $numero_dias * $cantidad_v  ;
        $valor_liquidacion_r =  332850 *  $numero_dias * $cantidad_v  ;
          ...
          $valor_tarifa =  475672;
        $valor_liquidacion = 475672  *   $numero_dias * $cantidad_v  ;
        $valor_liquidacion_r =  475700  *   $numero_dias * $cantidad_v  ;
          ...
          $valor_tarifa =  951804;
        $valor_liquidacion = 951804 *  $numero_dias * $cantidad_v  ;
       ...
       $valor_liquidacion = 1427971 *   $numero_dias * $cantidad_v  ;
       ...
       $valor_liquidacion_r =  1904150  *   $numero_dias * $cantidad_v  ;
        ...
        $valor_liquidacion =  2380269  *   $numero_dias * $cantidad_v  ;
       ...
       $valor_liquidacion = 3332567 *  $numero_dias * $cantidad_v  ;
       $valor_liquidacion_r = 3332600 *  $numero_dias *$cantidad_v  ;
        ...
        $valor_liquidacion = 4284866  *   $numero_dias * $cantidad_v  ;
       ...
       $valor_liquidacion = 8160204  *  $numero_dias * $cantidad_v  ;
       $valor_liquidacion_r = 8160200 *  $numero_dias * $cantidad_v ;
      }elseif ($valor_liquidacion >= $valor_tarifa_evento_1500  && $valor_liquidacion < $valor_tarifa_evento_2115) {
        $valor_tarifa =10917526;
        $valor_liquidacion = 10917526 *   $numero_dias * $cantidad_v  ;
 ...
 /**
  ...
  public function fapiExampleMultistepFormNextSubmit2(array &$form, FormStateInterface $form_state) {
    $form_state
      ->set('page_values3', [
        // Keep only first step values to minimize stored data.
        'first_name' => $form_state->getValue('valor_evento_pfj'),
      ...
      ->setRebuild(TRUE);
        ...
        $this->setSessionValue('session_liquidacion.field_select_NV_pfj', $form_state->getValue('field_select_NV_pfj'));
