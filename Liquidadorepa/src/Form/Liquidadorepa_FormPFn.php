...
*/
  ...
  $numero_dias = $form_state->getValue('numero_dias_pfn');
       ...
       if ($valor_liquidacion < $valor_tarifa_evento_25) {
        ...
        $valor_liquidacion = 209559  *  $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion_r = 237600 *   $numero_dias * $cantidad_v ;
          ...
          $valor_tarifa =419718;
        $valor_liquidacion = 419718  *   $numero_dias * $cantidad_v ;
        $valor_liquidacion_r =  332850 *  $numero_dias * $cantidad_v ;
          ...
          $valor_tarifa =  599854;
        $valor_liquidacion = 599854  *   $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion = 1200308 *  $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion = 1800763 *   $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion =  2401217  *   $numero_dias * $cantidad_v ;
       $valor_liquidacion_r =  1904150  *   $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion =  3001671  *   $numero_dias * $cantidad_v ;
