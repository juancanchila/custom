...
*/
  ...
  $numero_dias = $form_state->getValue('numero_dias_pfn');
       ...
       if ($valor_liquidacion < $valor_tarifa_evento_25) {
        ...
        $valor_liquidacion = 172702 *  $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion = 242129 *  $numero_dias * $cantidad_v ;
        $valor_liquidacion_r = 166200 *  $numero_dias * $cantidad_v ;
          ...
          $valor_tarifa =346098;
        $valor_liquidacion =346098  *  $numero_dias * $cantidad_v ;
        $valor_liquidacion_r = 237600 *   $numero_dias * $cantidad_v ;
          ...
          $valor_tarifa =484837;
        $valor_liquidacion = 484837  *   $numero_dias * $cantidad_v ;
        $valor_liquidacion_r =  332850 *  $numero_dias * $cantidad_v ;
          ...
          $valor_tarifa =  693004;
        $valor_liquidacion = 693004  *   $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion = 1386587 *  $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion = 2080284 *   $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion =  2773866  *   $numero_dias * $cantidad_v ;
       $valor_liquidacion_r =  1904150  *   $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion =  3467564  *   $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion = 4854844*  $numero_dias * $cantidad_v ;
       $valor_liquidacion_r = 3332600 *  $numero_dias * $cantidad_v ;
        ...
        $valor_liquidacion = 6242123  *   $numero_dias * $cantidad_v ;
       ...
       $valor_liquidacion = 104039624  *  $numero_dias * $cantidad_v ;
       $valor_liquidacion_r = 104039620 *  $numero_dias * $cantidad_v ;
      }elseif ($valor_liquidacion >= $valor_tarifa_evento_1500  && $valor_liquidacion < $valor_tarifa_evento_2115) {
        $valor_tarifa =14669885;
        $valor_liquidacion = 14669885 *   $numero_dias * $cantidad_v ;
