...
namespace Drupal\custom_rules_action_denuncia\Plugin\RulesAction;
...
/**
 * Provides a 'Denuncia action' condition.
 *
 * @RulesAction(
 ...
 *
 */
class DenunciaID extends RulesActionBase
{
...
$visita = Node::create(['type' => 'denuncias']);
$visita->set('title', 'Denuncia');
$visita->enforceIsNew();
$visita->save();
